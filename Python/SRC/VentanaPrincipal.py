...
class VentanaSecundaria(Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.frame_proceso = Frame(self.frame,bg="#004173")
        ...
        self.ventana_operaciones = Frame(self.frame,relief="groove",bd=2,bg="#b6ffff")
        ...
        #ZONA DE LABELS
        self.label_proceso = Label(self.frame_proceso,text= "TURBINA TOURS AND RESORT", font = ("Segoe UI", 12,"bold"),height=2,bg="#004173")
        self.label_proceso.pack(ipadx = 2, ipady =2, padx = 5, pady= 5)

        self.label_descripcion = Label(self.frame_descripcion, text = "Sistema para la venta de tiquetes y alojamientos, y modificación por parte de un administrador", font = ("Segoe UI", 10), bg="#0979b0")
    ...
    def agregarAerolinea(self):
        ...
        self.ventana_operaciones= Frame(self.frame,relief="groove",bd=2)
        self.ventana_operaciones.pack(ipadx = 2, ipady =2, padx = 2, pady= 2,fill=X)
        self.f=Label(self.ventana_operaciones, text="Ingrese el nombre de su Aerolinea").pack()
        self.en=Entry(self.ventana_operaciones)
        self.en.pack()
        def crearAerolinea():
            Aerolinea(self.en.get())
            self.l = Label(self.ventana_operaciones, text="Estas son las aerolineas existentes en nuestro sistema", font = ("Segoe UI", 12,"bold")).pack()
            for i in Aerolinea.getAerolineas():
                self.la= Label(self.ventana_operaciones, text=i.getNombre())
                self.la.pack()

        self.aceptar = Button(self.ventana_operaciones, text="Aceptar", command=crearAerolinea).pack(side="left", padx=100)
        self.borrar = Button(self.ventana_operaciones, text="Borrar").pack(side="right", padx=100)
    def eliminarAerolinea(self):
        ...
        for i in Aerolinea.getAerolineas():
            self.la= Label(self.ventana_operaciones, text=i.getNombre())
            self.la.pack()
        self.f=Label(self.ventana_operaciones, text="Ingrese el nombre de la Aerolinea que desea borrar").pack()
        self.en=Entry(self.ventana_operaciones)
        self.en.pack()
        def cerrarAerolinea():
            ...
            for l in Aerolinea.getAerolineas():
                self.laa= Label(self.ventana_operaciones, text=l.getNombre())
                self.laa.pack()

        self.aceptar = Button(self.ventana_operaciones, text="Aceptar", command=cerrarAerolinea).pack(side="left", padx=100)
        self.borrar = Button(self.ventana_operaciones, text="Borrar").pack(side="right", padx=100)
    ...
    def ayuda(self):
        ayudaPopUp = messagebox.showinfo(title = "Desarrolladores", message ="Jhoneker Delgado Urbina\n Emmanuel Valencia Lopera\n Simon Guarin Cortes \n Jesus Camilo Miranda Aguirre\n Andres Jacobo Leal Aguirre")
